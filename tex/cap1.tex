...
\end{equation}
$F_X(x)$ è una funzione di $x$ monotona, nondecrescente e definita su tutto l'asse reale con con le proprietà: $ \lim_{x \to - \infty }F_X(x) = 0$ e $ \lim_{x \to + \infty }F_X(x) = 1$. Se $F_X(x)$ è ovunque differenziabile, la variabile aleatoria $X$ è continua. Dunque una densità di probabilità $p_X(x)$ associata ad $X$ esiste e soddisfa
\begin{equation}
