...
Questa osservazione è importante poichè per poter campionare la distribuzione di Boltzmann sarà necessario avere metodi che possono generare configurazioni distribuite secondo una distribuzione conoscendola a meno della costante di normalizzazione.