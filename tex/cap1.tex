...
La distribuzione di probabilità associata a una variabile aleatoria continua $X$ è descritta da una densità di probabilità $p_X(x)$ La densità di probabilità deve soddisfare la condizione di normalizzazione ed essere non negativa per ogni valore della variabile aleatoria:
\begin{equation}
